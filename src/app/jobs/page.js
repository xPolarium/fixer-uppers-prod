...
import { TextField, InputAdornment, IconButton, Grid, Paper, Avatar, Rating } from '@mui/material';
    ...
    >
      ...
      <Box flex="1 1 0" minWidth={0} textAlign="center">
        <TextField
            ...
            aligment = 'center'
            sx={{
              borderRadius: '999px', // Makes it fully rounded (oval/pill shape)
              px: 3,                 // Horizontal padding (adjust as needed)
              textTransform: 'none' // Keeps "Search" casing as-is
            }}
          />
          <Button
            variant="outlined"
    ...
    >
      <Box flex="0 0 auto" minWidth={60}>
        <Box>
          ...
          <br />
          <Typography>Jobs Type</Typography>
